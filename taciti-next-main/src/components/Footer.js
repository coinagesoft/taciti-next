            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-3 col-md-6 col-12">
                  <img src="/images/logo_footer.png" alt="Taciti Logo" />
                  <br />
                  <div className="addres">
                    Suite #225 <br />
                    8580 Belleview Drive, Plano, Texas 75024, USA
                  </div>
                  <p>
                    <a
                      href="mailto:info@taciti.com"
                ...
                <div className="col-lg-3 col-md-6 col-12">
                  ...
                  <ul>
                    ...
                    <li><Link href="/industries/life-sciences">Life Sciences</Link></li>
                    <li><Link href="/industries/consumer-packaged-goods">Consumer Packaged Goods</Link></li>
                    <li><Link href="/industries/hi-tech">Hi-Tech</Link></li>
                    <li><Link href="/industries/utilities">Utilities</Link></li>
                  </ul>
                </div>
                ...
                <div className="col-lg-3">
                  ...
                  <div className="footer-head2" style={{ marginTop: "30px" }}>
                    Follow us
                  </div>
                  <ul>
                    <li style={{ listStyle: "none" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", width: "50%" }}>
                        <div>
                          <a href="https://x.com/Taciti_it" target="_blank" rel="noopener noreferrer">
                        ...
                        <div>
                          <a href="https://www.linkedin.com/company/taciti-consulting" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <div>
                          <a href="https://www.instagram.com/taciti_Consulting/" target="_blank" rel="noopener noreferrer">
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
