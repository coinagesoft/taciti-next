  ...
  return (
    <div className="pa-page">
      ...
      <section className="pa-overview">
        ...
        <p>
          With a specialized focus on SAP S/4HANA, we are the experts in
          crafting and executing large-scale ERP-led transformations that
      ...
      <section className="pa-features">
        <div className="pa-features-grid">
          ...
          <div className="pa-card">
            ...
            <p>
              Deep expertise to help clients adopt SAP S/4HANA. We have
              expertise across Greenfield, Brownfield or Select Migration
              Projects.
            </p>
          </div>
          ...
          <div className="pa-card">
            ...
            <p>
              We bring industry thought leadership to help design and adopt
              leading practices to improve market competitiveness of our clients
          ...
          <div className="pa-card">
            ...
            <p>
              Through our in-depth analysis and established methodology, we
              bring about process and performance improvements across the
          ...
          <div className="pa-card">
            ...
            <p>
              End to end program and project management expertise to ensure
              successful execution of ERP transformation.
            </p>
          </div>
          ...
          <div className="pa-card">
            ...
            <p>
              Expertise to drive organizational change management and enable
              employees, partners, customers with appropriate training and
              learning strategy.
            </p>
          </div>
          ...
          <div className="pa-card">
            ...
            <p>
              New SAP product capabilities across the domains including SAP BTP,
              CPI, Cloud Platform, Archiving, Generative AI applications.
            </p>
          </div>
        ...
        <div className="pa-exp-box">
          ...
          <div className="pa-exp-grid">
            ...
            <div className="pa-exp-col">
              <p>
                ERP Strategy, Roadmap &amp; Business Case Development
              </p>
              ...
              <p>
                SAP Center of Excellence Design and Implementation
              </p>

              <p>
                Global Business Process &amp; Performance Improvement Services
              </p>
            </div>
            ...
            <div className="pa-exp-center">
              ...
              <div className="pa-brain-outer">
                <div className="pa-brain-inner">
                  ...
                  <img
                    src="/Taciti assets/assets-27.png"
                    alt="Our Expertise"
                  />
            ...
            <div className="pa-exp-col pa-exp-col--right">
              ...
              <p>
                Industrialized SAP Development
              </p>

              <p>
                SAP Activate-Based Agile Program Execution &amp; Management
              </p>
