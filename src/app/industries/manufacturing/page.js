    ...
    <div className="mfg-page">
      ...
      <section className="mfg-hero">
        <div className="mfg-hero-box">
          <h1 className="mfg-hero-title">
            Solution For The<br />Manufacturing Industries
          </h1>
        </div>
      </section>
      ...
      <section className="mfg-overview">
        ...
        <p>
          ...
          your manufacturing to deliver high value to your customers and stakeholders.
        </p>
        <p>
          The key enabler to manufacturing industry growth is addressing manufacturing and supply chain
          challenges. A few of them that we have seen are highlighted below:
        </p>
      ...
      <section className="mfg-solutions">
        ...
        <p className="mfg-solutions-intro">
          We offer specialized solutions across the manufacturing value chain with highly engineered
          product offerings imperative to build connected and integrated factories across people,
        ...
        <div className="mfg-pillars">
          ...
          <div className="mfg-pillar">
            <div className="mfg-pillar-icon">
              <img src="/Taciti assets/assets-39.png" alt="Expertise" />
            </div>
            <h3>Expertise</h3>
            <p>
              Deep manufacturing expertise and not just IT consultants. End-to-end manufacturing
              knowledge resonating with shop floor culture
            </p>
          </div>

          <div className="mfg-pillar">
            <div className="mfg-pillar-icon">
              <img src="/Taciti assets/assets-40.png" alt="Unbiased Opinion" />
            </div>
            <h3>Unbiased Opinion</h3>
            <p>
              Unbiased consultancy to adopt new technologies with clients&apos; interests at the
              forefront. Emphasis on the practical adoption of the solution and not
              &ldquo;Conference Room&rdquo; design
            </p>
          </div>

          <div className="mfg-pillar">
            <div className="mfg-pillar-icon">
              <img src="/Taciti assets/assets-41.png" alt="Transformation" />
            </div>
            <h3>Transformation</h3>
            <p>
              Value-based transformation of processes by adopting industry-leading technologies and
              best practices. Transformation to adopt Industry 4.0 realistically
            </p>
          </div>

          <div className="mfg-pillar">
            <div className="mfg-pillar-icon">
              <img src="/Taciti assets/assets-42.png" alt="Upskill To Innovate" />
            </div>
            <h3>Upskill To Innovate</h3>
            <p>
              Help build CoEs to upskill client&apos;s resources to adopt next-gen technologies to
              provide a better experience internally and externally
            </p>
          </div>
        ...
        <div className="mfg-solutions-grid">
          ...
          <div className="mfg-solution-item">
            ...
            <p>
              (Ex: Cloud computing application on the cloud for better resource utilization
          ...
          <div className="mfg-solution-item">
            ...
            <p>
              (Ex: Adopting state-of-the-art integration platforms and strategies to ensure
